...
export const products: Product[] = [
  ...
  { id: "h5", name: "清真速冻饺子 — 牛肉洋葱", nameEn: "Halal Frozen Dumplings - Beef & Onion", spec: "1kg/袋", moq: "500袋", priceRange: "¥28/kg", supplier: "惠发食品", certType: "HALAL", image: "/media/product-frozen-dumplings.jpg", category: "速冻调理品", subcategory: "速冻水饺", exportRegions: ["东盟", "中东"], moqRange: "1-5吨", supplierQuals: ["出口食品生产备案", "AEO认证", "HACCP"], services: ["支持样品单", "可代办清关", "支持OEM"], origin: "山东" },
  { id: "h6", name: "清真牛肉丸 — 手工打制", nameEn: "Halal Beef Meatballs - Handmade", spec: "500g/袋", moq: "1000袋", priceRange: "¥38/kg", supplier: "惠发食品", certType: "JAKIM", image: "/media/product-beef-meatballs.jpg", category: "牛羊肉制品", subcategory: "速冻肉丸", exportRegions: ["东盟", "中东", "中亚"], moqRange: "1-5吨", supplierQuals: ["出口食品生产备案", "源头工厂", "AEO认证", "HACCP"], services: ["支持样品单", "支持拼柜", "可代办清关", "支持OEM"], origin: "山东", isHot: true },
  { id: "h7", name: "惠发清真鱼豆腐", nameEn: "Huifa Halal Fish Tofu", spec: "300g/袋", moq: "2000袋", priceRange: "¥12/袋", supplier: "惠发食品", certType: "JAKIM", image: "/media/product-beef-meatballs.jpg", category: "速冻调理品", subcategory: "速冻肉丸", exportRegions: ["东盟", "中东"], moqRange: "1-5吨", supplierQuals: ["出口食品生产备案", "源头工厂", "AEO认证"], services: ["支持样品单", "支持拼柜", "可代办清关", "济南仓可提货"], origin: "山东", isBestSeller: true },
  { id: "h8", name: "惠发清真速冻春卷", nameEn: "Huifa Halal Frozen Spring Rolls", spec: "20只/袋", moq: "600袋", priceRange: "¥18/袋", supplier: "惠发食品", certType: "HALAL", image: "/media/product-frozen-dumplings.jpg", category: "速冻调理品", subcategory: "速冻春卷", exportRegions: ["东盟", "北非"], moqRange: "1-5吨", supplierQuals: ["出口食品生产备案", "AEO认证", "HACCP"], services: ["支持样品单", "可代办清关", "济南仓可提货"], origin: "山东" },
];
