...
export interface Product {
  id: string;
  /**
   * Product SKU code — the ASIN-like identifier used in URLs and display.
   * Format: `PT` + 8 chars (e.g. "PTJJUHG5T7").
   * Sourced from the backend `sku_code` field; for frontend-only products a
   * temporary code is generated locally. When present it takes precedence over
   * `id` for routing and display.
   */
  skuCode?: string;
  name: string;
  nameEn?: string;
...
export const products: Product[] = [
  ...
  // 新增16个产品
  { id: "p9", name: "清真冻鸭胸肉", nameEn: "Halal Frozen Duck Breast", spec: "10kg/箱", moq: "100箱", priceRange: "$3.5 - $4.0", supplier: "PoultryPrime", certType: "HALAL", image: "/media/product-lamb-skewers.jpg", category: "牛羊肉制品", subcategory: "牛肉卷", exportRegions: ["中东", "北非"], moqRange: "5-10吨", supplierQuals: ["出口食品生产备案", "源头工厂"], services: ["支持拼柜", "可代办清关"], origin: "河北" },
  { id: "p10", name: "清真手抓饼", nameEn: "Halal Scallion Pancake", spec: "5片/袋", moq: "800袋", priceRange: "$1.5 - $1.8", supplier: "BakeryHalal", certType: "HALAL", image: "/media/product-sesame-bread.jpg", category: "清真预制菜", subcategory: "速冻面点", exportRegions: ["东盟"], moqRange: "1-5吨", supplierQuals: ["出口食品生产备案", "源头工厂"], services: ["支持样品单", "济南仓可提货"], origin: "河南", isHot: true },
  ...
  // 惠发食品产品线（与数据库一致，8款，命名统一为"惠发清真"前缀）
  { id: "h1", skuCode: "PTKNQ3UIBD", name: "惠发清真冷冻羊腿肉（分割）", nameEn: "Huifa Halal Frozen Lamb Leg (Cut)", spec: "20kg/箱", moq: "100箱", priceRange: "¥85/kg", supplier: "惠发食品", certType: "JAKIM", image: "/media/product-lamb-skewers.jpg", images: ["/media/product-lamb-skewers.jpg", "/media/product-curry-sauce.jpg", "/media/product-beef-meatballs.jpg", "/media/product-frozen-dumplings.jpg", "/media/product-instant-soup.jpg", "/media/product-curry-beef.jpg"], videos: [{ url: "/media/product-demo.mp4", thumbnail: "/media/product-lamb-skewers.jpg", duration: "0:45", title: "产品展示视频" }, { url: "/media/product-demo2.mp4", thumbnail: "/media/product-curry-sauce.jpg", duration: "1:20", title: "生产流程视频" }], category: "清真肉制品", subcategory: "羊排", exportRegions: ["东盟", "中东", "中亚"], moqRange: "5-10吨", supplierQuals: ["出口食品生产备案", "源头工厂", "AEO认证", "HACCP"], services: ["支持样品单", "支持拼柜", "可代办清关"], origin: "山东", isHot: true },
  { id: "h2", skuCode: "PTVXN4TVHE", name: "惠发清真咖喱牛肉（预制菜）", nameEn: "Huifa Halal Curry Beef Ready Meal", spec: "500g/盒", moq: "800盒", priceRange: "¥45/盒", supplier: "惠发食品", certType: "JAKIM", image: "/media/product-curry-sauce.jpg", category: "清真预制菜", subcategory: "即食便当", exportRegions: ["东盟", "中东"], moqRange: "1-5吨", supplierQuals: ["出口食品生产备案", "源头工厂", "AEO认证"], services: ["支持样品单", "支持拼柜", "支持OEM"], origin: "山东", isBestSeller: true },
  { id: "h3", skuCode: "PT19QUFR1C", name: "惠发清真孜然粉（调味料）", nameEn: "Huifa Halal Cumin Powder Seasoning", spec: "1kg/袋", moq: "500袋", priceRange: "¥15/kg", supplier: "惠发食品", certType: "GSO", image: "/media/product-curry-sauce.jpg", category: "清真调味品", subcategory: "复合调味料", exportRegions: ["东盟", "中东", "中亚"], moqRange: "1-5吨", supplierQuals: ["出口食品生产备案", "源头工厂", "AEO认证"], services: ["支持样品单", "支持拼柜", "支持OEM"], origin: "山东" },
  { id: "h4", skuCode: "PTL9F0ZE9J", name: "惠发清真奥尔良烤鸡翅（腌制）", nameEn: "Huifa Halal Roasted Chicken Wings", spec: "2kg/袋", moq: "300袋", priceRange: "¥35/kg", supplier: "惠发食品", certType: "HALAL", image: "/media/product-lamb-skewers.jpg", category: "清真预制菜", subcategory: "调理肉制品", exportRegions: ["东盟", "中东", "中亚"], moqRange: "1-5吨", supplierQuals: ["出口食品生产备案", "源头工厂", "AEO认证"], services: ["支持样品单", "支持拼柜", "可代办清关"], origin: "山东", isHot: true },
  { id: "h5", skuCode: "PT2YTRC7WL", name: "惠发清真速冻包子（牛肉大葱）", nameEn: "Huifa Halal Frozen Buns - Beef & Scallion", spec: "1kg/袋", moq: "400袋", priceRange: "¥26/kg", supplier: "惠发食品", certType: "HALAL", image: "/media/product-frozen-dumplings.jpg", category: "清真预制菜", subcategory: "速冻面点", exportRegions: ["东盟", "中东"], moqRange: "1-5吨", supplierQuals: ["出口食品生产备案", "AEO认证", "HACCP"], services: ["支持样品单", "可代办清关", "支持OEM"], origin: "山东" },
  { id: "h6", skuCode: "PTH7TP87AG", name: "惠发清真牛肉丸（手工打制）", nameEn: "Huifa Halal Beef Meatballs - Handmade", spec: "500g/袋", moq: "1000袋", priceRange: "¥38/kg", supplier: "惠发食品", certType: "JAKIM", image: "/media/product-beef-meatballs.jpg", category: "清真肉制品", subcategory: "速冻肉丸", exportRegions: ["东盟", "中东", "中亚"], moqRange: "1-5吨", supplierQuals: ["出口食品生产备案", "源头工厂", "AEO认证", "HACCP"], services: ["支持样品单", "支持拼柜", "可代办清关", "支持OEM"], origin: "山东", isHot: true },
  { id: "h7", skuCode: "PTHXDZ4NEF", name: "惠发清真鱼豆腐（速冻）", nameEn: "Huifa Halal Fish Tofu (Frozen)", spec: "300g/袋", moq: "2000袋", priceRange: "¥12/袋", supplier: "惠发食品", certType: "JAKIM", image: "/media/product-beef-meatballs.jpg", category: "清真零食", subcategory: "鱼糜制品", exportRegions: ["东盟", "中东"], moqRange: "1-5吨", supplierQuals: ["出口食品生产备案", "源头工厂", "AEO认证"], services: ["支持样品单", "支持拼柜", "可代办清关", "济南仓可提货"], origin: "山东", isBestSeller: true },
  { id: "h8", skuCode: "PTFCEQBH93", name: "惠发清真速冻春卷", nameEn: "Huifa Halal Frozen Spring Rolls", spec: "20只/袋", moq: "600袋", priceRange: "¥18/袋", supplier: "惠发食品", certType: "HALAL", image: "/media/product-frozen-dumplings.jpg", category: "清真零食", subcategory: "速冻春卷", exportRegions: ["东盟", "北非"], moqRange: "1-5吨", supplierQuals: ["出口食品生产备案", "AEO认证", "HACCP"], services: ["支持样品单", "可代办清关", "济南仓可提货"], origin: "山东" },
];
...
export const suppliers: Supplier[] = [
  ...
  },
  {
    ...
    logo: "HF",
    tier: "S",
    categories: ["速冻调理品", "清真预制菜", "牛羊肉制品"],
    certs: ["JAKIM", "HALAL", "GSO", "MUI"],
    exportVolume: "$12M+",
    location: "山东",
    foundedYear: 2005,
    description: "北方最大速冻清真调理品生产基地，拥有现代化生产线3条，年产能超5万吨。惠发品牌在东南亚、中东享有盛誉，支持全品类OEM定制，是多家国际连锁商超核心供应商。",
    exportRegions: ["东盟", "中东", "中亚"],
    businessType: "品牌运营商",
    qualifications: ["出口食品生产备案", "AEO认证", "HACCP", "ISO22000"],
    ...
    employeeCount: "1500+",
    isTangyuanhui: true,
    productImages: ["/media/product-beef-meatballs.jpg", "/media/product-frozen-dumplings.jpg", "/media/product-instant-soup.jpg"],
    storeId: "huifa",
  },
  {
    id: "s6",
...
export const news: NewsItem[] = [
  { id: "n1", title: "平台正式上线，首批50家供应商入驻", excerpt: "国际清真食品产业平台（IHF）于今日正式上线运营，首批50家优质供应商完成入驻审核...", date: "2026-06-20", category: "平台动态" },
...
export const newsArticles: NewsArticle[] = [
  {
    id: "na1",
    title: "IHF 平台正式上线，首批 50 家供应商完成入驻",
    excerpt: "国际清真食品产业平台（IHF）于今日正式上线运营，首批 50 家优质供应商已完成入驻审核，涵盖清真预制菜、速冻调理品、牛羊肉制品等六大品类。平台将为供应商提供从认证到物流的全链路出海服务。",
    date: "2026-07-01",
    category: "平台动态",
    source: "IHF 官方",
    sourceType: "official",
  ...
  {
    id: "na6",
    title: "Lulu 集团与 IHF 达成战略合作，开放 200+ 商超渠道",
    excerpt: "中东最大零售集团 Lulu 与 IHF 签署战略合作协议，向平台供应商开放 200+ 海外商超渠道资源，首批 20 家供应商产品已进入 Lulu 采购体系。",
    date: "2026-06-18",
    category: "合作伙伴",
    source: "Lulu 集团",
    sourceType: "partner",
  ...
  },
  {
    ...
    excerpt: "IHF 联合山东出入境检验检疫局举办清真食品出口合规专题培训，围绕出口备案、卫生注册、标签合规等核心环节，为 60 余家企业提供实操指导。",
    date: "2026-05-22",
    category: "平台动态",
    source: "IHF 官方",
    sourceType: "official",
  ...
  },
  {
    ...
    excerpt: "IHF 上线在线验厂功能，海外采购商可通过平台 VR 全景 + 实时视频方式远程审核供应商工厂的清真生产环境、卫生条件与认证资质，降低差旅成本。",
    date: "2026-05-15",
    category: "平台动态",
    source: "IHF 官方",
    sourceType: "official",
  ...
  },
  {
    ...
    excerpt: "IHF 上线认证进度看板功能，供应商可实时查看 HALAL 认证办理进度，包括资料提交、审核、现场检查、发证等各环节状态与预计完成时间。",
    date: "2026-04-22",
    category: "平台动态",
    source: "IHF 官方",
    sourceType: "official",
