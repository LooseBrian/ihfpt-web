...
import { serviceHotSearchTags } from "@/lib/data";
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-brand-100 text-base md:text-lg mb-8 max-w-2xl mx-auto">
            以产品贸易为基础，叠加合规认证、跨境物流、渠道拓展、金融配套一站式增值服务
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-2xl mx-auto mb-6">
            <div className="relative flex-1">
              ...
              <Input
                placeholder="搜索服务项目：HALAL 认证、冷链双清、出口信保..."
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 text-sm">
            <span className="text-brand-200">热门服务：</span>
            {serviceHotSearchTags.map((tag) => (
              <button
                key={tag}
